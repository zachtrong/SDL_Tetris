...
ScenePlay::ScenePlay()
	...
	textScoring(new FontObject("1000", 50, SDL_Rect{144, 353, 0, 0}, true)),
	textFooter(new FontObject("press ESC or P to pause", SDL_Rect{59, 555, 0, 0})),
...
void ScenePlay::updateViewBoard(Board &board) {
	...
	for (auto shadow : shadows) {
		...
		if (0 <= convertedId && convertedId < boardTileObjectId && boardTileObjects[convertedId]->type == EMPTY) {
